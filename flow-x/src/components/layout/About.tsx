    ...
    <>
      <div className="w-full flex justify-center  items-center p-[8rem 0rem] gap-[6.06rem]">
        ...
        <div className="w-[35.25rem] h-[22.18rem] flex flex-col justify-start gap-5">
          <h2 className="text-[3rem] leading-[3.6rem] text-[#E7E7E7]">
            Your team of specialists
          </h2>
          <p className="font-inter text-[1rem] leading-[1.6rem] text-[#B0B0B0]">
          ...
          <ButtonBlackMedium>More about us</ButtonBlackMedium>
        </div>
      </div>
    </>
  );
